...
use Faysal0x1\LaraPayment\SslCommerz\SslCommerzNotification;
...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $s_info = array();
        $s_info['shipping_method'] = 'Yes';
        $s_info['num_of_item'] = 1;
        $s_info['ship_name'] = 'Abc';
        $s_info['ship_add1'] = 'Dhaka';
        $s_info['ship_add2'] = '';
        $s_info['ship_city'] = 'Dhaka';
        $s_info['ship_state'] = '';
        $s_info['ship_postcode'] = '1215';
